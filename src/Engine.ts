...
import { SdiColor, SdiPoint3D } from './types/engine-types/EngineTypes';
...
export default class Engine {
  ...
  async initializeScene(): Promise<void> {
    ...
    // this.createPointLight('Blue', { color: vec4.fromValues(0.21, 0.01, 1.0, 0.0) }, defaultTransform().translate([10, 10, 0]));
    ...
    const sunLight = new DirectionalLight({
      ...
      color: new SdiColor(1.0, 1.0, 1, 1.0),
      intensity: 1.0
    });

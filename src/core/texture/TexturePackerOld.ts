...
export default class TexturePackerOld {
    ...
    private generatePackedTexture(
        ...
        // const scaleX = originalWidth === 1 && originalHeight === 1 ? 0 : scaledWidth / this.atlasWidth;
        // const scaleY = originalWidth === 1 && originalHeight === 1 ? 0 : scaledHeight / this.atlasHeight;
